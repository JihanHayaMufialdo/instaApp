    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-100 dark:border-gray-100">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                @endif --}}
                <form action="{{route('register-attempt')}}" method="POST" class="max-w-sm mx-auto">
                    @csrf
                    <div class="mb-2">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('login') }}" class="font-small text-blue-600 dark:text-blue-500 hover:underline">
                            Login
                        </a>
                    </div>
                </form>
